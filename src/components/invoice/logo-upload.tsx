    ...
    <Card>
      ...
      <div className="flex items-start gap-6">
        <div className="flex-shrink-0">
          <div className="w-32 h-20 rounded-lg border-2 border-dashed border-neutral-300 bg-neutral-50 flex items-center justify-center overflow-hidden">
            {displayLogoUrl ? (
              <Image
                src={displayLogoUrl}
                alt="Company logo"
        ...
        <form action={formAction} className="flex-1">
          <div className="flex items-center gap-3">
            <input
              ...
              className="flex-1 text-sm text-neutral-600 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-neutral-100 file:text-neutral-700 hover:file:bg-neutral-200 file:cursor-pointer"
            />
            <SubmitButton />
          </div>
